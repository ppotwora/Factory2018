...
namespace Fabryka2018.Controllers
{
    public class OperatorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Imię,Nazwisko,Płaca")] Operator @operator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Imię,Nazwisko,Płaca")] Operator @operator)
        {
            if (ModelState.IsValid)
            {
